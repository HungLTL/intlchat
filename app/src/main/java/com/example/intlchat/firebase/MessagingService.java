package com.example.intlchat.firebase;
...
import com.example.intlchat.activities.ChatActivity;
...
public class MessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage message) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            String channelDesc = "This notification channel is used for chat message notifications";
